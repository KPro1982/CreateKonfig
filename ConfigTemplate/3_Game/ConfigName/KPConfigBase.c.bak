class KPConfigBase<Class T>
{
	...
	void Init()
	{
		...
		if(GetGame().IsDedicatedServer())
		{
			...
			GetRPCManager().AddRPC( "ModName", "XXX_SendCommandToServer", this, SingeplayerExecutionType.Both );
		}
		else
		{
			GetRPCManager().AddRPC( "ModName", "XXX_SendDataToClient", this, SingeplayerExecutionType.Both );		
		}
